...
def studentsView(request):
    ...
    # students = Student.objects.all() # Manual Serialization
    # students_list = list(students.values()) 
    # return JsonResponse(students_list, safe=False)
    
    #Serializiling using Serializer
...
#         return Response(status=status.HTTP_204_NO_CONTENT)
    ...
    #Done With Today 19/04/2025
    
    
# 3.Class Based Views but used :- Mixins Based Views
"""
# get and post
...
"""
# 4. Class Based View but used : Generics 
# get and post
...
# 5 Class Based Views but used ViewSets
